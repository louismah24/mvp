...
export function ChargingStation({ colorScheme, newLocation }) {
  const navigation = useNavigation();

  const chargingCoordinates = [
    {
      latitude: 1.4344106,
      ...
      <View className="p-10 w-1/2">
        ...
        <View className="flex flex-row gap-4 mt-6">
          <View className="flex flex-col border-2 border-blue-300 dark:border-[#7601ff] p-4 rounded-lg w-1/2">
            <Text
              className="text-black dark:text-white text-center font-semibold"
              onPress={() => handleClick(chargingCoordinates[1])}
            >
              Go Now
            </Text>
          </View>
      ...
      <View className="p-10 w-1/2">
        ...
        <View className="flex flex-row gap-4 mt-6">
          <View className="flex flex-col border-2 border-blue-300 dark:border-[#7601ff] p-4 rounded-lg w-1/2">
            <Text
              className="text-black dark:text-white text-center font-semibold"
              onPress={() => handleClick(chargingCoordinates[0])}
            >
              Go Now
            </Text>
          </View>
